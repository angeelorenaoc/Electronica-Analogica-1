...
void loop() {
  do{
    ...
    //Serial.print(x);
    if (d >= 90 || d <= 0){  // si la distancia es mayor a 120cm o menor a 0cm 
      ...
      if(x==0){
          tone(Buzzer1,2093);//2093;1047  //DO 5ta 8va
        }
      else if(x==1){
          tone(Buzzer2,1175);//2349;1175  //RE 5ta 8va
        }
      else if(x==2){
          tone(Buzzer3,1323);//2637;1319  //MI 5ta 8va
        }
      else if(x==3){
          tone(Buzzer4,1397);//2794;1397  //FA 5ta 8va
        }
      else if(x==4){
          tone(Buzzer5,1575);//3136;1568  //SOL 5ta 8va
      } 
      else if(x==5){
          tone(Buzzer6,1760);//3520;1760  //LA 5ta 8va
        }
      else if(x==6){
          tone(Buzzer7,1976);//3951;1976  //SI 5ta 8va
        }
      else if(x==7){
          tone(Buzzer8,2093);//2093);//2093);  //DO 6ta 8va
        }  
      	delay(700);                    
